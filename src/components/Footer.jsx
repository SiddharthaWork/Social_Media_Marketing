    ...
    <footer className="bg-[#14142B] w-full h-full text-white py-16 pt-44 pb-8 relative overflow-hidden">
      <div className="absolute left-[80.83%] right-[-10.24%] top-[-27.54%]">
        <img
          src="circle.png"
          alt=""
          className="sm:hidden md:block" // Hide the image at sm-320 breakpoint
        />
      </div>

      <div className="absolute left-[-6.25%] right-[90.49%] top-[76.53%] bottom-[-23.32%] opacity-35">
        <img
          src="circle2.png"
          alt=""
          className="xs:hidden md:block" // Hide the image at sm-320 breakpoint
        />
      </div>

      <div className="container mx-auto px-6 md:px-[250px] relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 smtab:gap-16 ">
        ...
        {/* Horizontal Line */}
        <hr className='mt-8 w-full h-full opacity-25' />
